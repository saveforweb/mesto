...
const popupImageCloseButton = document.querySelector(
  ".popup-fullscreen__button-close"
);
...
const popupProfileSubtitleInput = document.querySelector(
...
const popupContentPlaceInput = document.querySelector(
  ".popup__input_type-content-place"
);
const popupContentLinkInput = document.querySelector(
  ".popup__input_type-content-link"
);
...
// общие функции
const openOverlay = function (openPopup) {
  // открытие оверлея
...
profileButton.addEventListener("click", function () {
  // открытие редактирования редактирования профиля
...
contentButton.addEventListener("click", (e) => {
  // открытие редактирования добавления контента
